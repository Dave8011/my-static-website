function loadHeader() {
    ...
    <header>
        <div class="logo">
            <a href="${basePath || '/'}">
                <img src="${basePath}images/icons/logo.webp" alt="The Rehab House Logo" width="282" height="47">
            </a>
        </div>
        ...
        <div class="header-actions">
            ...
            <div class="search-box">
                ...
                <button onclick="triggerSearch()" aria-label="Search"><img src="${basePath}images/icons/search-icon.webp" alt="Search" width="24" height="24"></button>
            </div>
        </div>
    </header>`;
        ...
        <div class="footer-container">
            ...
            <div class="footer-brand">
                <a href="${basePath || '/'}" class="footer-logo">
                    <img src="${basePath}images/icons/logo.webp" alt="The Rehab House" width="198" height="33">
                </a>
                ...
                <div class="social-icons-row">
                     ...
                     <a href="https://wa.me/919653699526" target="_blank" aria-label="WhatsApp"><img src="${basePath}images/icons/whatsapp.svg" alt="WA"></a>
                     ...
                     <a href="https://share.google/ck7EpIC9kXnToRH1I" target="_blank" aria-label="Google"><svg class="google-icon-svg" width="20" height="20" viewBox="0 0 24 24" fill="white"><path d="M21.35 11.1h-9.17v2.98h5.69c-.59 2.77-2.86 4.45-5.29 4.45-3.27 0-5.91-2.63-5.91-5.91s2.64-5.91 5.91-5.91c1.29 0 2.52.41 3.49 1.15l2.25-2.25C16.96 4.24 14.8 3.5 12.18 3.5 7.4 3.5 3.5 7.4 3.5 12.18s3.9 8.68 8.68 8.68c4.68 0 8.84-3.4 8.84-8.84 0-.61-.06-1.3-.17-1.92z"/></svg></a>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const schemaJSON = {
        ...
        "image": "https://www.therehabhouse.in/images/home/hero-banner.jpg",
